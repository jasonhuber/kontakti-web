...
import { Search, User, Building2, Briefcase, MessageSquare, FileText } from 'lucide-react'
...
export function GlobalSearch({ open, onOpenChange, onNavigate }: Props) {
  ...
  // Close on Escape (handled by cmdk), open on Cmd+K
  useEffect(() => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center pt-[20vh]">
      ...
      <div className="relative w-full max-w-xl">
        <Command className="rounded-xl border border-zinc-200 bg-white shadow-2xl overflow-hidden">
